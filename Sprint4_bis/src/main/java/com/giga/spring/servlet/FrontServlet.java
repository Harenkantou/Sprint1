...
public class FrontServlet extends HttpServlet {
    ...
    */
    ...
    private void handleReturnType(Object result, HttpServletRequest request, HttpServletResponse response) 
        throws ServletException, IOException {
        if (result instanceof String) {
            // Gestion des retours de type String
            response.getWriter().write((String) result);
        } else if (result instanceof ModelView) {
            // Gestion des retours de type ModelView
            ModelView modelView = (ModelView) result;
            String viewUrl = modelView.getView();
            // Transférer les attributs vers la requête
